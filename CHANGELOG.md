...
*(Merge note: the `## Unreleased` header items for P5.2+P5.3 (#634) and the coupling host auto-scalers (#635) were dropped by an earlier CHANGELOG conflict resolution — both restored above; their sections were never lost.)*
