...
::
    ...
    results.viewer()                  # open pyGmshViewer (no session needed)
...
class Results:
    ...
    ``pyvista`` and ``pyGmshViewer`` are deferred to call-time.
    ...
    def from_file(
        ...
        *,
        ...
        """
        from pyGmshViewer.loaders.vtu_loader import load_file
    ...
    def viewer(self, *, blocking: bool = True) -> None:
        """Open the results in pyGmshViewer.
