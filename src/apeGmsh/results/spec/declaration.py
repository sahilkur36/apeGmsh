...
if TYPE_CHECKING:
    ...
    # The legacy ``OpenSees`` bridge class was deleted in Phase γ
    # (PR #130).  The optional ``opensees`` back-reference is now
    # typed as ``Any`` — no live consumer passes it.
