...
Lives under :mod:`apeGmsh.results.spec` because the spec is consumed
by the results layer (capture, live driver, MPCO emit, transcoders,
writers).  Relocated from ``apeGmsh.solvers._recorder_specs`` in
Phase 8.3b.
...
class ResolvedRecorderSpec:
    ...
    def to_tcl_commands(
        ...
        file_format : str
            ...
            to text.
        """
        from ._emit import emit_spec_tcl
    ...
    def to_python_commands(
        ...
        from ._emit import emit_spec_python
    ...
    def to_mpco_tcl_command(
        ...
        """
        from ._emit import emit_mpco_tcl
    ...
    def to_mpco_python_command(
        ...
        from ._emit import emit_mpco_python
