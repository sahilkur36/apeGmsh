...
def test_opensees_reader_version_is_2_17_0() -> None:
    """Schema 2.17.0 — node-pair zeroLength inline_connectivity (ADR 0049)."""
    assert reader_version(OPENSEES) == SchemaVersion(2, 17, 0)
